...
**If no tasks are found**: The script will output "No tasks found". When this happens, report this to the user and STOP. Do NOT search for tasks in other folders like `in-progress`, `ready-for-review`, or `completed`.
